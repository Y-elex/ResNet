...
import sys
sys.path.append('E:/python_code/annotated_deep_learning_paper_implementations/labml_nn')
sys.path.append('E:/python_code/annotated_deep_learning_paper_implementations')
...
class Configs(CIFAR10Configs):
    ...
    pretrained_model_path: str = 'best_model_AffectNet.pth'  # 预训练模型路径
...
def main():
    ...
    # 设置数据集路径
    train_dir = 'E:/python_code/FER/datasets/AffectNet/train'
    valid_dir = 'E:/python_code/FER/datasets/AffectNet/val'
    ...
    for epoch in range(conf.epochs):
        ...
        if val_acc > best_acc:
            best_acc = val_acc
            torch.save(model.state_dict(), 'best_model_AffectNet.pth')  # 保存最佳模型
    ...
    # 保存为 Excel 文件
    df.to_excel('training_log_AffectNet.xlsx', index=False)
    ...
    plt.tight_layout()
    plt.savefig('E:/python_code/results/accuracy_loss_plot_AffectNet.png')
    plt.show()
